<template>
  <el-collapse v-model="activeName" accordion>
    ...
    <el-collapse-item title="What is the difference between Tip with username and without username?" name="2">
      <div>If you want to enter a tip without a user name, you will receive the normal tip address from TangleBay. For a tip with a user name, you can use the TangleBay node with authentication (more secure).</div>
    </el-collapse-item>
    <el-collapse-item title="How long is the access time to the TangleBay private nodes?" name="3">
    ...
    <el-collapse-item title="Why should anyone tip for TangleBay?" name="4">
